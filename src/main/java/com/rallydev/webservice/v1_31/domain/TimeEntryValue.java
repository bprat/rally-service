...
public class TimeEntryValue  extends com.rallydev.webservice.v1_31.domain.WorkspaceDomainObject  implements java.io.Serializable {
    ...
    private com.rallydev.webservice.v1_31.domain.TimeEntryItem timeEntryItem;
    ...
    public TimeEntryValue(
           ...
           com.rallydev.webservice.v1_31.domain.TimeEntryItem timeEntryItem) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public com.rallydev.webservice.v1_31.domain.TimeEntryItem getTimeEntryItem() {
        return timeEntryItem;
    }
     ...
     * @param timeEntryItem
     */
    public void setTimeEntryItem(com.rallydev.webservice.v1_31.domain.TimeEntryItem timeEntryItem) {
        this.timeEntryItem = timeEntryItem;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "TimeEntryValue"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "TimeEntryItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
