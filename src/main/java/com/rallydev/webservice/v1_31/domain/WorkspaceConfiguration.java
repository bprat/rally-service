...
public class WorkspaceConfiguration  extends com.rallydev.webservice.v1_31.domain.WorkspaceDomainObject  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "WorkspaceConfiguration"));
