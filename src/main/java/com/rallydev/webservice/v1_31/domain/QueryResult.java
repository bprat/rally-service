...
public class QueryResult  extends com.rallydev.webservice.v1_31.domain.OperationResult  implements java.io.Serializable {
    ...
    private com.rallydev.webservice.v1_31.domain.DomainObject[] results;
    ...
    public QueryResult(
           ...
           com.rallydev.webservice.v1_31.domain.DomainObject[] results) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return results
     */
    public com.rallydev.webservice.v1_31.domain.DomainObject[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(com.rallydev.webservice.v1_31.domain.DomainObject[] results) {
        this.results = results;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "QueryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "DomainObject"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
