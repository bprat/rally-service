...
public class TestSet  extends com.rallydev.webservice.v1_31.domain.Artifact  implements java.io.Serializable {
    ...
    /**
     * Gets the tasks value for this TestSet.
     * 
     * @return tasks
     */
    ...
    /**
     * Sets the tasks value for this TestSet.
     * 
     * @param tasks
     */
    ...
    /**
     * Gets the testCaseStatus value for this TestSet.
     * 
    ...
    /**
     * Sets the testCaseStatus value for this TestSet.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "TestSet"));
