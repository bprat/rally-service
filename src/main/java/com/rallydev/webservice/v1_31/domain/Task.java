...
public class Task  extends com.rallydev.webservice.v1_31.domain.Artifact  implements java.io.Serializable {
    ...
    public Task(
           ...
           com.rallydev.webservice.v1_31.domain.Project _project,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_31/domain", "Task"));
